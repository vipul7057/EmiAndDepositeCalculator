...
body {
	background-image:
		url('https://cdn.mos.cms.futurecdn.net/KeCy9X5MKy6WHiKZgDpcAk.jpg');
	...
	<div style="display: flex; height: 80vh">
		<div
			...
			<div style="height: 30vh; width: 500px">
				<h1 style="color: black; font-weight: 600">
					WE COMBINE <span><br></span>BUSINEES WITH FINANCE
				</h1>
		...
		<div
			...
			<div
				...
				class="bg-dark">
				<spr:form action="AdminLoginFinal.htm" method="post"
					commandName="user" class="login" style="">
					...
					<div style="color: grey">Lorem ipsum dolor sit amet,
